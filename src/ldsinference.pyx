...
cdef _filter_predict(transition_matrix, transition_covariance,
...
@cython.boundscheck(False) # turn off bounds-checking for entire function
cdef _filter_correct(observation_matrix, observation_precision,
    ...
    predicted_observation_precision = _woodbury_inversion(
...
@cython.boundscheck(False) # turn off bounds-checking for entire function
cdef _smooth_update(transition_matrix, filtered_state_mean,
